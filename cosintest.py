...
dict_to_json(valid_data_dict, 'valid42t.json')
...
for epoch in range(epochs):
    ...
    if accuracy2 > max_eval_rate:
        ...
        torch.save(model_to_save.state_dict(), "./model_save2/similarQueryt.bin")
        torch.save(mymodel, "./model_save2/similarQueryt.pt")
        print("保存成功")
