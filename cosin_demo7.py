...
file_name = "./similary_query/combine_all2.json"

all_query, all_document = get_data5(file_name)
# 86946
all_train_query, all_train_document, all_valid_query, all_valid_document = get_all_train_valid_data(all_query, all_document, 80000, 6940)
...
dict_to_json(valid_data_dict, 'valid53.json')
...
for epoch in range(epochs):
    ...
    with torch.no_grad():
        for data2 in tqdm(val_loader):
            ...
            # print(out_matrix2)
            # print(label_matrix2)
            loss2, current_num2 = lossFunction2(out_matrix2, labels_list2, 0, 2000, valid_log_name)
            # print(loss2)
            # print(current_num2)
            # 计算准确率
    ...
    if accuracy2 > max_eval_rate:
        ...
        torch.save(model_to_save.state_dict(), "./model_save2/similarQuery2.bin")
        torch.save(mymodel, "./model_save2/similarQuery2.pt")
        print("保存成功")
