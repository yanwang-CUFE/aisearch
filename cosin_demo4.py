...
all_valid_query, all_valid_document, all_valid_label = get_sample_data(all_valid_query, all_valid_document, 128, VALID_SIZE)
print("测试保存的模型")
print(all_valid_query[0])
print(all_valid_document[0])
...
# dict_to_json(valid_data_dict, 'valid30.json')
...
for epoch in range(epochs):
    ...
    with torch.no_grad():
        for data2 in tqdm(val_loader):
            ...
            # print(labels_list2)
            out_matrix2 = torch.zeros([2, 128, 312, Valid_BATCH_SIZE])
            ...
            # print(out_matrix2)
            # print(label_matrix2)
            loss2, current_num2 = lossFunction2(out_matrix2, labels_list2, 0, 128, valid_log_name)
            # print(loss2)
            # print(current_num2)
            # 计算准确率
    ...
    if accuracy2 > max_eval_rate:
        ...
        torch.save(mymodel.state_dict(), "./model_save2/model.bin")


        max_eval_rate = accuracy2
