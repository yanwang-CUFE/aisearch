...
dict_to_json(valid_data_dict, 'requery_valid.json')
...
class BertAISearchModel(nn.Module):
    def __init__(self):
        ...
        self.dense = nn.Linear(self.bert.config.hidden_size, 512)  # 312 input, 1 output
    ...
    def forward(self, ids, mask):
        ...
        output_512 = self.dense(output)
        output_64 = self.fc1(self.act1(output_512))
        out_1 = self.fc2(self.act2(output_64))
        return out_1
