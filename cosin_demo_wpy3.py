...
dict_to_json(valid_data_dict, 'valid55.json')
...
for epoch in range(epochs):
    ...
    if accuracy2 > max_eval_rate:
        ...
        torch.save(model_to_save.state_dict(), "./model_save2/model8t0.25.bin")
        torch.save(mymodel, "./model_save2/mymodel8t0.25.pt")
        print("保存成功")
